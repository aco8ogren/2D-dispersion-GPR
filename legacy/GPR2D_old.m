function out = GPR2D_old(data,struct_idx,eig_idx,N_sample,isMakePlots,isUsePolar)
    
    if ~exist('isUsePolar','var')
        isUsePolar = false;
    end
    ...
    N_h = N_sample; % number of sample points sampled in the long direction of the rectangle for GPR
